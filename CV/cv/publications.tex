...
%	CONTENT
%-------------------------------------------------------------------------------
\setcounter{pubCounter}{25} % Set to total number of publications
...
{\textbf{ICML 2025} Workshops: AI for Math, PRAL, ES-FoMo}
...
{\textbf{UIST 2024} (ACM Symposium on User Interface Software and Technology), NeurIPS 2023 Workshops: XAIA, ICBINB}
...
{\textbf{ICLR 2024, Spotlight} (top 5\% of submissions), ICLR 2023 Workshops: TrustML (Oral), ME-FoMo}
...
{\textbf{ICML 2023, Oral} (top 2\% of submissions)}
